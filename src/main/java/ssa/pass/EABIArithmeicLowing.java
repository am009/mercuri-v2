...
public class EABIArithmeicLowing {
    public static Map<String, Func> extFuncs;
        ...
        for (var inst : bb.insts) {
            if (inst instanceof BinopInst) {
                ...
                if (extFuncs.containsKey(key)) {
                    ...
                    var call = new CallInst.Builder(inst.parent, func.getValue()).addArg(op1.value).addArg(op2.value)
                            .build();
